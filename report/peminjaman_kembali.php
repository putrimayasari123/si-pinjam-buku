            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PEMINJAMAN BUKU DIKEMBALIKAN</h3>
                        <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM pinjam JOIN anggota ON pinjam.id_anggota=anggota.id_anggota JOIN buku ON pinjam.id_buku=buku.id_buku WHERE status_pinjam='Sudah dikembalikan'";
                                    ...
                                    <tr>
                                        <td>
                                            <table>
                                                ...
                                                ?>
                                                <tr>
                                                    <th>Jumlah Dikembalikan</th><td>&nbsp;  : &nbsp;</td><td> <?= $total2 ?> Buku</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td></td>
