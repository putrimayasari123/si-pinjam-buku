...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?page=utama">Sistem Informasi Peminjaman Buku Perpustakaan</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="?page=anggota&actions=tampil">Anggota</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="report/buku.php" target="_blank">Laporan Buku</a></li>
                        <li><a href="report/anggota.php" target="_blank">Laporan Anggota</a></li>
